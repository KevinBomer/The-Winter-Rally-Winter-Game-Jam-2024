...
## IMAGES
################################################################################
## The mouse images used for resizing. Requires an image called "move" somewhere
## in your images folder.
image left_right_cursor = Transform("move", rotate=90, rotate_pad=False)
image top_bottom_cursor = Transform("move")
...
image move_cursor = Fixed("left_right_cursor", "top_bottom_cursor", fit_first=True)
