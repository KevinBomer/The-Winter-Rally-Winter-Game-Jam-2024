...
label act6:
    ...
    if locked_in_ending in ["good", "neutral"]:
        ...
        morg "Yes... yes, like I'd never believed." # (fear easing)

        mortis "Then you shall have no problems in regaling me with your escapades." # (giggles)

        morg "From the very start? Well..."

        morg "I gathered my friends and we set out to complete a list."
        ...
        morg "I... I tried. I promise I tried." # (despaired)

        mortis "Enlighten me. Tell me about your day."

        morg "I'll give you what I have."

        morg "We started out with a list we wanted to fill."
    ...
    if locked_in_ending == "bad":
        ...
        morg "He was busy. He told us no... so it was just us three."

        morg "We tried to make things better with some food, but..." # (O.S.)

        morg "Without our other friends, the benches were noticeably empty." # (O.S.)
        ...
        morg "It turns out I just... don't have it in me anymore." # (O.S.)

        ##SCENE EXT. HILL WITH A VIEW - NIGHT with dissolve

        morg "And— and that's it. I dunno what to say."

        morg "There's the fireworks coming up, but..."
        ...
        morg "No... it's not fair. I need—" # (shakily)
        ...
        morg "I can't... not yet... please..." # (weakly)
        ...
        morg "After all, if I could go so far out of my way to see Finn, then so could he for me. And he agreed." # (O.S.)
        ...
        morg "And this one friend who couldn't make it today spread the word about the place enough for it to get a lot of new regulars." # (O.S.)

        if check_act3_minigame_success():
            morg "Plus, the atmosphere… I think they really missed us all." # (O.S.) # (sighs)
        else:
            morg "If only we could've handled their clientelle..."
        ...
        if act4_focus_minigame_success:
            morg "It was like I'd never left." # (O.S.)

            morg "I just can't get across how unchaining it felt to dance and sprint and— just— wow! I get giddy thinking about it." # (O.S.)
        else:
            morg "I think my body betrayed me, though."

            morg "If I could have just known my limits, I would have NEVER embarrassed myself in front of everyone."
        ...
        morg "But I don't like to kiss and tell, so, that's that on that. (laughs)" # (O.S.)

        ##SCENE EXT. HILL WITH A VIEW - NIGHT with dissolve

        if locked_in_ending == "good":
            morg "Now we're just going to see the fireworks, and then..."
        elif locked_in_ending == "neutral":
            morg "Hopefully the fireworks can bring it home."
        ...
        if locked_in_ending == "good":
            morg "Please, just one extra day. I promise—"
            ...
            morg "It could have gone better, really. Maybe if I had—"
        ...
        if locked_in_ending == "good":
            ...
            morg "Right... right. Okay." # (composing her breaths)

            morg "I'm going. This is the fireworks ceremony, this is... this is it. I won't keep them waiting any longer."

            morg "Thank you. For today."
            ...
            morg "Like they always have." # (composing her breaths)

            morg "So... this really is it? Okay."

            morg "I can't keep them waiting any more."
    ...
    morg "Huh—? Oh— yeah, I'm here! I'm okay!"
    ...
    if locked_in_ending == "neutral":
        ter "Don'tchu worry. The fireworks will be just grand."
    ...
    if locked_in_ending == "bad":
        ...
        ter "It's nearly time to start. Let's go." # (soft)
        ...
        ter "C'mon, just a few steps to go. I gota good feelin' about these fireworks."
