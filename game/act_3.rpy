...
label statueop:
    ...
    Group 1
    Customer One
    Can I get the Yummy Yam Roll?
    Customer Two
    I would like the Dragon Roll. I’m also allergic to shellfish.
    #Miya enters stage right
    Miya
    What did customer one want?
    Terrie
    BC Roll
    Dragon Roll
    Yummy Yam Roll
    Miya
    What did customer two want?
    Terrie
    Dragon Roll
    BC Roll
    Shrimp Tempura roll
    ...
    Terrie
    Customer one and it’s a shellfish allergy.
    Customer one and it’s a ginger allergy.
    Customer two and it’s a shellfish allergy.
    Terrie
    Here’s your orders!
    #Miya fades out
    If Correct
    ...
    Customer Two
    No shellfish, right? Thank you very much.
    If Incorrect
    Customer One
    Wait… I wanted the Yummy Yam Roll! Please take this back.
    Customer Two
    Come on. This isn’t the right roll. Take it back.
    Customer Two
    Is that shellfish? I said I was allergic. Take it back.
    Group 2
    Customer Three
    Can I get the Shrimp Tempura roll? Also, I’m allergic to ginger.
    Customer four
    ...
    Narration (cont’d)
    As we began absorbing the moment, Morgan spoke up, her energy at an all-time high.
    Morgan (smiling)
    This is truly going to be a meal worth dying for. It’s a meal that we all earned through our hard work and effort.
    Morgan (smiling)
    This might be one line on my list, but it means the world to me. Thank you everyone… for being here.
    If unsuccessful
    THE SPOT - CORRIDOR
    Narration
    ...
    #Finn enters stage left
    Finn
    I’ll… apologize to my sister later for wasting her effort.
    #Finn fades out
    Branches merge
    THE SPOT - DAY
    Narration
    ...
    #Finn enters stage left
    Finn
    Terrie is right, I enjoyed this a lot more than I anticipated.
    Morgan lets out a sigh of relief.
    Morgan
    I’m so glad.
    Narration (cont’d)
    As if on cue, Finn’s phone began to ring.
    Finn
    Ah. It’s Mina. Let me give her the news.
    Finn picks up, and is greeted by Mina’s voice.
    #Finn fades out
    #Morgan fades out
    #Mina enters stage right
    ...
    #Finn enters stage left
    Finn
    You wish. They’re only coming back because the food is just that good.
    Mina
    Nuh-uh! They’re definitely coming back thanks to me and my cute lil’ face. You owe me!
    Finn
    Sure.
    #Finn fades out
    ...
    I don’t.
    Terrie
    Okay liar liar pants on fire, no need to be a tough guy around us. 
    Terrie (cont’d)
    ...
    If Finn is there
    Morgan (reading list)
    Let’s see... Oh! We can either have the performance of a lifetime, or get married! I’m down for either.
    Terrie
    Marriage huh ? Well, I guess that’s certainly a bucket list worthy thing.
    #Finn enters stage left
    Finn
    I’m certain this can only go well.
    #Finn fades out
    #Morgan fades out
    THE SPOT - CORRIDOR
    Narration
    ...
    Morgan (happy)
    I’m ready for all of us to show the world our talent!
    Time to get married.
    Morgan (happy)
    A marriage under the night sky... how romantic.
    Choices merge here
    #Morgan fades out
    Narration
    With the decision made, we were off once again.
    Narration (cont’d)
    I knew the day was coming to a close soon, so it was up to us to finish strong.
    Narration (cont’d)
    To make sure the next event was something worth remembering.
    All exit
    If Finn is not there
    Morgan (reading list)
