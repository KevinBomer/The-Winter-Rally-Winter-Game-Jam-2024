...
label start:
    ...
    mina "Get outta town, MORGAN?! Girly it's been forever! How are things?!" 
    mina "Uh, I mean, outside of the... hospital stuff." 
    ...
    mina "And you thought of me? D'aww."
    mina "What notice period am I lookin' at?" 
    morg "None. Obviously."
    #Beat.
    mina "Man, it really has been a million years." 
    mina "Ugh, how do I put this? for the last few months, streaming's gone so well that I, uh..."
    mina "LA called, and I went. Like, for good."
    mina "Morgan, I really wanna be there, like, really really, but with the timings and all I don't think I can—" 
    morg "It’s fine."
    mina "...You sure?"
    morg "Yes, really, Mina."
    mina "I can try making changes or something—"
    morg "i promise."
    ...
    mina "Morgan..."
    mina "You better tell me how things went after today, 'kay?"
    morg "You got it."
    mina "Mhm... listen, uh, I had a stream to set up for like, five minutes ago, so I gotta bounce.
    morg No worries! Go to work!"
    morg "Everyone will be cheering you on. We'll talk soon. Lots of love from us all."
    mina "Okay thank you guys miss you talk later byeeeeeee~! Sorry again bye gang. Buh-bye."
